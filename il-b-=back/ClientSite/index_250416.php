...
$abpath_unk_def_new = $_SERVER[DOCUMENT_ROOT]."/unk_def_new.php";
$abpath_unk_def = $_SERVER[DOCUMENT_ROOT]."/unk_def.php";

if( file_exists($abpath_unk_def_new) && !is_dir($abpath_unk_def_new) )
{
	require_once($abpath_unk_def_new);
	define('UNK',DEFINE_UNK);
	$from_fomain = 1;
}
elseif( file_exists($abpath_unk_def) && !is_dir($abpath_unk_def) )
{
...
if( $from_fomain == 1 )
{
	...
	if( UNK == "570999819807328184" OR UNK == "463855339088509570" OR UNK == "525482657832046717" OR UNK == "711720925699921333" )
		define('HTTP_PATH',"http://www.".$data_domain['domain']);
	else
	...
	$server_path = "/home/ilan123/domains/".$data_domain['domain']."/public_html";
		...
		if($data_domain['domain'] == 'cityportal.ilbiz.co.il'){
			require_once("version_1/version_t.php");
			die;
		}
