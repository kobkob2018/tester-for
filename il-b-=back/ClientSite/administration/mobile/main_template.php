	...
	<div id='page_master' class='container'>
		<div id='top_menu_wrap'>
			<div class="logo menu-item menu-all-item to-right" id="logo"> 
				<a href="../myleads/">
					<img src="mobile/style/image/logo-s10.png"  id="logo_img" alt="sherut10" style="height: 49px; padding:5px 0px;" />
				</a>
			</div>
			<div class="menu-item menu-leads_credit-item menu-all-item" id="leads_credit_wrap to-left"> 
				<div id="leads_credit">
					<img src="mobile/style/image/key-icon.png"  alt="Save this lead" style="width: 24px;" />
					<br/>
			...
			<div class="menu-item menu-buy_lead" id="open_lead_button_wrap to-left"> 
				<img src="mobile/style/image/key-icon.png"  id="open_lead_button" alt="Open this lead" style="width: 49px; padding: 5px;" />
			</div>
			<div class="menu-item menu-get_lead-item_notActive" id="save_lead_button_wrap to-left"> 
				<img src="mobile/style/image/Save-icon.png"  id="save_lead_button" alt="Save this lead" style="width: 49px; padding: 5px;" />
			</div>
		...
		<div id='get_data_mask' class='get-data-mask mask-div'>
			...
			<div class="mask-content">
				<img src="mobile/style/image/loading.gif"  id="gt_data_loadin_gif" alt="Loading" />
			</div>	
		</div>
		...
		<div id='main_content' data-current_screen='<?php echo $current_screen; ?>' data-get_row='<?php echo $oppenning_row_id; ?>' data-token='<?php echo $oppenning_token; ?>' >
			<div id='lead_list_wrap' class='main_content_item'>
			
			</div>
			<div id='buy_leads_wrap' class='main_content_item'>
				<iframe src="" id="buy_leads_iframe" style="margin:auto;"></iframe>
			</div>			
		...
		<div id="bottom_menu_wrap">
			<div class="menu-item  menu-get_lead-item menu-buy_leads-item back-to-list to-right" id="back_to_list_button_wrap"> 
				<img src="mobile/style/image/List-icon.png"  id="back_to_list_button" alt="Back to list" style="width: 49px; padding: 5px;" />
			</div>	
			<div class="menu-item  menu-lead_list-item menu-search_leads-item search-list to-left" id="search_list_button_wrap"> 
				<img src="mobile/style/image/Search-icon.png"  id="search_list_button" alt="Search" style="width: 49px; padding: 5px;" />
			</div>
			<div class="menu-item menu-all-item to-right" id="refresh_button"> 
				<a href="../myleads/" title="רענן">
					<img src="mobile/style/image/Refresh-icon.png"  id="refresh_img" alt="refresh" style="width: 50px; padding: 4px 0px;" />
				</a>	
			</div>	
			<div class="menu-item  menu-get_lead-item delete-lead to-left" id="delete_lead_button_wrap"> 
				<img src="mobile/style/image/Delete-icon.png"  id="delete_lead_button" alt="Delete this lead" style="width: 49px; padding: 5px;" />
			</div>			
			<div class="menu-item mass_edit_menu_item to-left" id="mass_irrelevant_leads_button_wrap"> 
				<img src="mobile/style/image/Irrelevant-icon.png"  id="mass_irrelevant_leads_button" alt="Mark as irrelevant" style="width: 49px; padding: 5px;" />
			</div>		
			<div class="menu-item mass_edit_menu_item to-left" id="mass_delete_leads_button_wrap"> 
				<img src="mobile/style/image/Delete-icon.png"  id="mass_delete_leads_button" alt="Delete this leads" style="width: 49px; padding: 5px;" />
			</div>	
	...
	<div style='display:none;' id='mokup_main'>
		...
		<div id='lead_row_mokup' class='lead-row'>
			...
			<div class="go_to_lead">
					...
					<div class='lead_item content'></div>
			</div>
		...
		<div id='lead_form_mokup' class='lead-form'>
			...
			<div class='refund_lead_form_mask' style="display:none;">	
				<form action="javascript://" class="refund_form">
					...
					<div>
						<b style="color:red">
							<?php echo $word[LANG]['72_hour_note']; ?>
						</b>
					</div>
			...
			<div class='72_hour_lead_alert_mask' style="display:none;">	
				
					<div class='lead_form_item form-group'>
						<h4 style='color:red;'>הסתיים תוקף הזיכוי על הליד.</h4>
					</div>
					<button type="button" class="72_hour_lead_alert_cancel form-button">חזור</button>
			...
			<form action="javascript://" class="details_form">
				...
				<div class="lead-form-content">
					...
					<div class='lead_form_item form-group'>
						...
						<a class="hidden phone-link"  href=""><img class="phone-link-img" src="mobile/style/image/Phone-icon.png" /></a>	
					</div>				
					<div class='lead_form_item form-group'>
