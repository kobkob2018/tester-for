...
function find_hebrew_charecters($filename)
{
  $hebrew_letter = array("..","à","á","â","ã","ä","å","æ","ç","è","é","ë","ì","î","ð","ñ","ò","ô","ö","÷","ø","","ù","ú","&","ê","ó","õ","^","$");
  $flag = false;
  for($i=0 ; $i<=strlen($filename) ; $i++)
  {
    if(in_array($filename{$i},$hebrew_letter) && $filename{$i})
    {
      $flag = true;
    }
  }
...
function FileUpload( $resourceType, $currentFolder )
{
	$sErrorNumber = '0' ;
	$sFileName = '' ;
	 $check_heb_name = find_hebrew_charecters($_FILES['NewFile']['name']);
    if($check_heb_name)
    {
