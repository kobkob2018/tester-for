...
if( isset($_POST['username']) && isset($_POST['password']) )
{
	...
	$end_date = $year."-".$mon."-".$day;
		...
		usa.username = '".$_POST['username']."' AND 
		usa.password = '".$_POST['password']."' AND 
		usa.deleted = '0' AND 
		usa.status = '0' AND 
		usa.unk = u.unk AND
	...
	<tr>
		<td>
			...
			<tr><td height="32"></td></tr>
				<tr>
					<td><a href='http://www.il-biz.co.il' target='_blank'><img src='http://www.ilbiz.co.il/sn/images/il-biz_logo_admin.png' border='0' alt='<?=$word[LANG]['login_logo_alt'];?>'></a></td>
				</tr>
				<tr><tD height=3></td></tR>
				<tr>
					<td align=center style='text-decoration: none; color:#19274C; font-size: 14px; font-family: arial,sans-serif;'><a href='http://www.il-biz.co.il' style='text-decoration: none; color:#19274C; font-size: 14px; font-family: arial,sans-serif;' target='_blank' title='<?=$word[LANG]['login_logo_alt'];?>'><b><?=$word[LANG]['login_logo_alt'];?></b></a></td>
				</tr>
			</table>
					...
					<tr>
						<td>
							<table border="0" cellspacing="0" cellpadding="0" class="maintext" align="center">
								...
								echo "<form action='login.php' name='changeLang' method='get'>
