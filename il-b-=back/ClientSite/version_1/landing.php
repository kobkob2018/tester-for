...
require('/home/ilan123/domains/ilbiz.co.il/public_html/lang/lang.he.php');

require('strac_func.php');

require('functions.php');

require('functions/client_castum_functions.php');
...
$bodyWidth = ( $landing_10service != "1" ) ? "width:775px; ".$bgcolor : "width:950px;  padding-right: 20px;";
?>
<style type="text/css">
	.body-table{
