			...
			echo "<ul id=\"menu\">";
				...
				while( $data_links_list_content = mysql_fetch_array($res_links_list_content) )
				{
					if( $data_links_list_content['hide_page'] == "0" )
					{
						...
						$name_to_url = stripslashes($data_links_list_content['name']);
						$url_href = "/".str_replace(" ","-",$name_to_url."/");
	...
	else
	{
			...
			while( $data_links_list_content = mysql_fetch_array($res_links_list_content) )
			{
				if( $data_links_list_content['hide_page'] == "0" )
				{
					...
					$name_to_url = stripslashes($data_links_list_content['name']);
					$url_href = "/".str_replace(" ","-",$name_to_url."/");
					//$url_href = "/".stripslashes($data_links_list_content['name']);
					$RMstr .= "<tr>";
						$RMstr .= "<td width='1'></td>";
						$RMstr .= "<td ".$img_bg_links." width='140' height='31' align='center'><a href=\"".$url_href."\" class=\"rightMemu\" title=\"".stripslashes($data_links_list_content['name'])."\">".stripslashes($data_links_list_content['name'])."<span></span></a></td>";
					$RMstr .= "</tr>";
					$RMstr .= "<tr><td colspan='2' height='3'></td></tr>";
				}
			}
