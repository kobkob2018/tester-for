			...
			if(!$is_landing){
				...
				if( $data_extra_settings['estimateSite'] == "1")
				{
					echo "<div class='bottom-copyright-leftside row-fluid span5'>";
							...
							echo "<div class='bottom-copyright-item bottom-copyright-sitemap span4'><a href='http://il-biz.co.il' class='headline' target='_blank' title='לידים איכותיים'><u>לידים איכותיים</u></a></div>";
							echo "<div class='bottom-copyright-item bottom-copyright-sitemap span4'><a href=\"http://il-biz.co.il/\" class=\"headline\" style=\"font-size:10px;\" target=\"_blank\" title='לידים'><img src='".HTTP_S."://www.ilbiz.co.il/sn/images/il-biz_logo.png' style='height:24px;' alt='לידים' title='לידים' /></a></div>";
