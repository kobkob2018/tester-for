...
//ini_set('display_errors', 1);
	...
	if($add_form_counts){
	$table_fields[] = array("select_as"=>"form_counts","str"=>"לידים מתוך הטפסים","sum"=>'1','color'=>'#beffbe');
	$table_fields[] = array("select_as"=>"presentage_forms_sent","str"=>"%","sum"=>'0','color'=>'#ece6e6');
	$table_fields[] = array("select_as"=>"send_counts","str"=>"שליחה מטפסים","sum"=>'1','color'=>'#beffbe');
	}
	...
	*/
	...
	<div id="filter_wrap" style="padding: 15px;border: 1px solid black;background: #e6d7d7;margin: 15px 0px;">
		<h3>סינון תוצאות</h3>
		<div><a href="http://ilbiz.co.il/site-admin/index.php?main=anf&gf=customer_tracking_statistics&sesid=<?php echo SESID; ?>">איפוס פילטר</a></div>
		<form method="POST" action="" id="statistics_filter_form">
			...
			<div>
				...
				<?php if(isset($_REQUEST['site_id'])): ?>
					<div class="request_filter" style="margin-left: 20px;float:right;background: #e5e5fb;padding: 10px;border: 1px solid blue;"> 
						<a style="display:block;float:left;color:red;border: 1px solid red;font-family: sans-serif;cursor: pointer;font-size: 11px;margin-right: 15px;font-weight: bold;" onclick="remove_param_from_stats_and_go('site_id');">בטל בחירה</a>
						<b>אתר:</b><br/>
				...
				<?php if(isset($_REQUEST['tracking_date'])): ?>
					<div class="request_filter" style="margin-left: 20px;float:right;background: #e5e5fb;padding: 10px;border: 1px solid blue;"> 
						<a style="display:block;float:left;color:red;border: 1px solid red;font-family: sans-serif;cursor: pointer;font-size: 11px;margin-right: 15px;font-weight: bold;" onclick="remove_param_from_stats_and_go('tracking_date');">בטל בחירה</a>
						<b>תאריך:</b><br/>
				...
				<?php if(isset($_REQUEST['tracking_hour'])): ?>
					<div class="request_filter" style="margin-left: 20px;float:right;background: #e5e5fb;padding: 10px;border: 1px solid blue;"> 
						<a style="display:block;float:left;color:red;border: 1px solid red;font-family: sans-serif;cursor: pointer;font-size: 11px;margin-right: 15px;font-weight: bold;" onclick="remove_param_from_stats_and_go('tracking_hour');">בטל בחירה</a>
						<b>שעה:</b><br/>
