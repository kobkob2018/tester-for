...
'LBL_ATTACH_FILE'=>'הצמדת קובץ',
'LBL_STEP_SELECT_FILE'=>'שלב 1: בחירת קובץ',
'LBL_BROWSE_FILES'=>'יש ללחוץ על "עיון" ולבחור את הקובץ שיש להצמיד',
'LBL_DESCRIPTION'=>'שלב 2: כתיבת מעט תיאור על הקובץ',
'LBL_OPTIONAL'=>'(רשות)',
);
