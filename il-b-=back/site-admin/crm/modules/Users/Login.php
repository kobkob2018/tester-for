...
<tr>
	<td align=center><br><br><br><br>
		...
		<tr>
			...
			<tr>
				<td align=right><img src="themes/images/loginTopHeaderName.gif"></td>
			...
			<tr>
				<td align=left valign=top width=50% class=small style="padding:10px">
					...
					<tr>
					<td>
					<img src="themes/images/loginPromoText.gif" alt="vtiger 5 - ניהול לקוחות 100% קוד פתוח" title="vtiger 5 - ניהול לקוחות 100% קוד פתוח">
					</td>
					</tr>
					<tr>
					<td class=small dir=rtl style="padding-left:10px; color:#737373">
- ממשק משתמש מבוסס AJAX<br>
- ניהול הלקוח בכל שלבי החיים שלו<br>
- שיתוף פעולה בדואר אלקטרוני, פורטל וצ'אט<br>
- אבטחה מותאמת אישית בכל הרמות<br>
- דו"חות וגרפים מוכנים לשימוש<br>
					</td>
					</tr>
					</table>
				...
				<td align=center valign=top width=50%>
					...
					<table border="0" cellspacing="0" cellpadding="0" width=100%>
					<tr><td align=right><img src="themes/images/loginSignIn.gif" alt="כניסה" title="כניסה" border="0"></td></tr>
					<tr>
